...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile("company_logo")) {
            ...
            $destinationPath = public_path('projectt/client/');
        ...
        if ($request->hasFile("preview_img")) {
            ...
            $destinationPath = public_path('projectt/preview/');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile("company_logo")) {
            ...
            $company_logo_image->save($destinationPath . $company_logo_name);
            // delete old image
            if (File::exists("projectt/client/" . $project->company_logo)) {
                File::delete("projectt/client/" . $project->company_logo);
            }
        }
        if ($request->hasFile("preview_img")) {
            $preview_img_file = $request->file("preview_img");
            ...
            $preview_img_image->save($destinationPath . $preview_img_name);
            // delete old image
            if (File::exists("projectt/preview/" . $project->preview_img)) {
                File::delete("projectt/preview/" . $project->preview_img);
            }
        }
        $project->title = $request->title;
        $project->company_name = $request->company_name;
    ...
    public function store_image($project_id, Request $request)
    {
        ...
        if ($request->hasFile("project_image")) {
            ...
            $destinationPath = public_path('projectt/image/');
    ...
    public function destroy_image($project_id, $image_id)
    {
        ...
        if (File::exists("projectt/image/" . $image->image)) {
            File::delete("projectt/image/" . $image->image);
        }
        $image->delete();
