    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
      ...
      <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
          ...
          <div class="avatar avatar-xl">
            <img class="rounded-circle" src="user-assets/images/testimonial/testimonial-1-4.jpg" alt="">
          </div>
        </a>
...
<div class="d-flex align-items-center">
  <div class="toggle-icon-wrapper">
    ...
    <div class="d-flex align-items-center py-3"><img class="me-2"
        src="{{ asset('user-assets/images/grassland-logo-01-01.png')}}" alt="" width="150"><span
  ...
  <div class="navbar-vertical-content scrollbar">
    <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
      ...
      {{-- <li class="{{ URL::current() == route('admin.dashboard') ? 'active' : '' }}">
        <!-- parent pages--><a class="nav-link dropdown-indicator" href="{{ route('admin.dashboard') }}" role="button"
      ...
      <li class="nav-item">
        ...
        <a class="{{ URL::current() == route('admin.dashboard') ? 'active' : '' }}" href="{{ route('admin.dashboard') }}" role="button">
        ...
        <a class="{{ URL::current() == route('admin.profile') ? 'active' : '' }}" href="{{ route('admin.profile') }}" role="button">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1"> Account Settings</span></div>
          </a>
          </li>
        <!-- label-->
        <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
        ...
        </div><!-- parent pages--><a class="{{ URL::current() == route('admin.testimonial.index') ? 'active' : '' }}" href="{{ route('admin.testimonial.index') }}" role="button">
          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Testimonial</span></div>
        </a>
      ...
      <li class="nav-item">
        <!-- label-->
        <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
          <div class="col-auto navbar-vertical-label"> Projects</div>
          <div class="col ps-0">
            <hr class="mb-0 navbar-vertical-divider">
          </div>
        </div><!-- parent pages--><a class="{{ URL::current() == route('admin.project.index') ? 'active' : '' }}" href="{{ route('admin.project.index') }}" role="button">
          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">All Projects</span></div>
        </a>
      ...
      <li class="nav-item">
        ...
        </div><!-- parent pages--><a class="{{ URL::current() == route('admin.message.index') ? 'active' : '' }}" href="{{ route('admin.message.index') }}" role="button">
          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Contact Form</span></div>
        </a>
       ...
       <li class="nav-item">
        ...
        </div><!-- parent pages--><a class="{{ URL::current() == route('admin.website-settings.index') ? 'active' : '' }}" href="{{ route('admin.website-settings.index') }}"
          role="button">
          <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Website Settings</span>
          </div>
        </a>
...
<ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
  ...
  <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button"
      data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      <div class="avatar avatar-xl">
        <img class="rounded-circle" src="{{ asset('user-assets/images/testimonial/testimonial-1-4.jpg')}}" alt="">
      </div>
    </a>
    <div class="dropdown-menu dropdown-caret dropdown-caret dropdown-menu-end py-0"
      aria-labelledby="navbarDropdownUser">
